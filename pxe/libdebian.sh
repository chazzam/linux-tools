...
EOR
    ...
    local append_line="vga=788 locale=en_US keymap=us time/zone=US/Central clock-setup/utc=true clock-setup/ntp-server=us.pool.ntp.org grub-installer/only_debian=true protocol=http mirror/http/directory=/${DISTRO} mirror/country=manual mirror/http/proxy= mirror/http/hostname=${MIRROR_BASE}"
