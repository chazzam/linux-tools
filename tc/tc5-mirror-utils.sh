...
TC_TCZ="5.x/x86/tcz";
TC_RELEASE="5.x/x86/release";
TC_TCZ_64="5.x/x86_64/tcz";
TC_RELEASE_64="5.x/x86_64/release";

# We need to know the kernel version for dependency resolution.
TC_KERNEL_VERSION="3.8.13-tinycore";
TC_KERNEL_VERSION_64="3.8.13-tinycore64";
